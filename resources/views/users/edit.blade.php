    ...
    <div class="row">
        <div class="col-lg-8 mt-2">
            <div class="card bg-dark" style="width: 26rem;">
                <div class="card-body">
                    <h5 class="card-title text-warning">Edit User</h5>
                    <form action="<?= route('user.update', ['id' => $user->id]) ?>" method="POST">
                        {{-- <input type="hidden" value="PUT" name="_method"/> --}}
                        <div class="mb-3 input-group-sm">
                            <label class="form-label text-light">Nama</label>
                            <input type="text" class="form-control" aria-describedby="emailHelp" value="<?= $user->nama ?>" name="nama">
                        </div>
                        <div class="mb-3 input-group-sm">
                            <label class="form-label text-light">Umur</label>
                            <input type="number" class="form-control" aria-describedby="emailHelp" value="<?= $user->umur ?>" name="umur">
                        </div>
                        <div class="mb-3 input-group-sm">
                            <label class="form-label text-light">Email address</label>
                            <input type="email" class="form-control" aria-describedby="emailHelp" value="<?= $user->email ?>" name="email">
